...
namespace flowsa\channel\fields;
...
class ChannelField extends Field
{
    ...
    {
        return Craft::t('channel', 'ChannelField');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'channel/_components/fields/ChannelField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'channel/_components/fields/ChannelField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,

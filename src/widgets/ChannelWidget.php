...
namespace flowsa\channel\widgets;

use flowsa\channel\Channel;
use flowsa\channel\assetbundles\channelwidgetwidget\ChannelWidgetWidgetAsset;
...
class ChannelWidget extends Widget
{
    ...
    {
        return Craft::t('channel', 'ChannelWidget');
    }
    ...
    {
        return Craft::getAlias("@flowsa/channel/assetbundles/channelwidgetwidget/dist/img/ChannelWidget-icon.svg");
    }
    ...
    public function getSettingsHtml(): ?string
    {
        return Craft::$app->getView()->renderTemplate(
            'channel/_components/widgets/ChannelWidget_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(ChannelWidgetWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'channel/_components/widgets/ChannelWidget_body',
            [
